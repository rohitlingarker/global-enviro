...
const navItems = [
  { title: 'Home', url: '/' },
  {
    ...
    dropdown: [
      ...
      { title: 'Mission & Vision', url: '/about/MissionVision' },
  ...
  },
  {
    ...
    dropdown: [
      { title: 'Air Pollution Control', url: '/service/AirPollutionControl' ,
        subDropdown: [
          { title: 'Pulse Jet Bag', url: '/service/AirPollutionControl/' },
          { title: 'Dust Extraction', url: '/service/AirPollutionControl/' },
          { title: 'Ash Handling', url: '/service/AirPollutionControl/' },
          { title: 'Centrifugal Fans', url: '/service/AirPollutionControl/' },
          { title: 'HVAC Clean Room', url: '/service/AirPollutionControl/' },
          { title: 'Clean Room Panel', url: '/service/AirPollutionControl/' },
        ],
      },
      { title: 'Material Handling', url: '/service/MaterialHandling',
        subDropdown: [
          { title: '', url: '/service/AirPollutionControl/BagFilters' },
          { title: 'Electrostatic Precipitators', url: '/service/AirPollutionControl/ElectrostaticPrecipitators' },
        ],
       },
      { title: 'HVAC', url: '/service/HVAC',
        subDropdown: [
          { title: 'HVAC System Components', url: '/service/AirPollutionControl/HVACComponents' },
          { title: 'Clean Room Equipments', url: '/service/AirPollutionControl/' },
        ],
       },
      { title: 'EPC Power', url: '/services/epc-power',
        subDropdown: [
          { title: 'Bag Filters', url: '/service/AirPollutionControl/BagFilters' },
          { title: 'Electrostatic Precipitators', url: '/service/AirPollutionControl/ElectrostaticPrecipitators' },
        ],
       },
    ],  
